        ...
        <>
            <section className={`dashboard ${darkMode ? 'dark-mode' : 'light-mode'}`}>
                <div className="top">
                    ...
                    <div className='project-head'>
                        <div className='project-title'>
                            <h3>Basic Structure Kanban Project</h3>
                            <ul>
                                <li><a href='#' className='hash-tag'>#BSKP</a></li>
                                <li><p className='sts'><UilCompleted /> Completed</p></li>
                                <li><p className='settings'><UilSetting /></p></li>
                                <li><p className='notify'><UilNotification /> </p></li>
                            </ul>
                        </div>
                ...
                >
                    ...
                    <Tab eventKey="tasks" title="Tasks">
                        ...
                        <div className='task-layouts container pt-3'>
                            <div className='row'>
                                ...
                                >
                                    <p className='layout-title b-primary'>BACKLOG <span>(0)</span></p>
                                    <p className='add-task'><UilAddon /> Add Task</p>
                                </div>
                                <div className='col-lg-3 col-md-12 col-sm-12 dnd'>
                                    <p className='layout-title b-default'>TO DO <span>({yetStartTasks.length})</span></p>
                                ...
                                <div className='col-lg-3 col-md-12 col-sm-12 dnd'>
                                    <p className='layout-title b-progress'>IN PROGRESS <span>({progressTasks.length})</span></p>
                                ...
                                <div className='col-lg-3 col-md-12 col-sm-12 dnd'>
                                    <p className='layout-title b-success'>COMPLETE <span>({doneTasks.length} of {tasks.length})</span></p>
                    ...
                    <Tab eventKey="milstones" title="Milstones" disabled></Tab>
                    <Tab eventKey="timesheets" title="Timesheets" disabled></Tab>
                    <Tab eventKey="files" title="Files" disabled></Tab>
                    <Tab eventKey="discussions" title="Discussions" disabled></Tab>
                    <Tab eventKey="activityfeed" title="Activity Feed" disabled> <p>Content for activity feed tab</p></Tab>
                </Tabs>
            </section>
        </>
    )
